...
<html lang="en">
<head>
<title>Global Trekking Travel Category Flat Bootstrap Responsive Web Template | Booking :: w3layouts</title>
...
<header>
	<div class="container">
		...
		<nav class="py-md-4 py-3 d-lg-flex">
			<div id="logo">
				<h1 class="mt-md-0 mt-2"> <a href="index.html"><span class="fa fa-map-signs"></span> Global Trekking </a></h1>
			</div>
		...
		<div class="contact-grids">
			<div class="row">
				<div class="col-lg-7 contact-left-form">
					<form method="post" class="row">
						...
						<div class="col-md-12 booking-button">
							<button name="submit" class="btn btn-block sent-butnn">Book Now</button>
						</div>
					</form>
				</div>
				<div class="col-lg-5 contact-right pl-lg-5">
					...
					<p class="mt-3">Our tour packages offer unique experiences that will create lasting memories. From cultural immersion to adventurous
					activities, there is something for everyone. Our knowledgeable guides ensure a smooth and enjoyable trip. Relax and let
					us take care of the details while you explore and discover new destinations.</p>
...
<?php 
	...
	if(isset($_POST['submit'])) 
	{
		...
		$add = mysqli_query($conn,"insert into booknow(name, email, phone, date, adults, kids, city, message) values('$name','$email','$phone','$date','$adults','$kids','$city','$message')") or die(mysqli_error($conn));
