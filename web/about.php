...
<html lang="en">
<head>
<title>Global Trekking Travel Category Flat Bootstrap Responsive Web Template | About :: w3layouts</title>
	...
	<div class="container py-lg-5 py-sm-4">
		<div class="row">
			<div class="col-lg-6 about-left">
				...
				<p class="mt-4">We offer travel services that take you to some of the world's most spectacular destinations, providing
					unforgettable
					experiences that cater to your unique preferences.</p>
				<p class="mt-3">Join us and experience the thrill of adventure, the magic of new cultures, and the serenity of natural
					wonders. Let us
						...
						<div class="row text-center">
							<div class="col-lg-4 col-md-6 inner-w3pvt-wrap">
								<div class="inner-sec-grid">
									...
									<p class="mt-3">Experience the magic of winter with our unforgettable tours. Book your adventure now!.</p>
								</div>
							</div>
							<div class="col-lg-4 col-md-6 inner-w3pvt-wrap">
								<div class="inner-sec-grid">
									...
									<p class="mt-3">Experience comfort and luxury with our range of carefully selected accommodations in top destinations worldwide.</p>
								</div>
							</div>
							<div class="col-lg-4 col-md-6 inner-w3pvt-wrap">
								<div class="inner-sec-grid">
									...
									<p class="mt-3">Get the best deals for your dream vacation with our affordable prices and unbeatable discounts.</p>
								</div>
							</div>
						</div>
					</section>
						...
						<div class="row text-center">
							<div class="col-lg-4 col-md-6 inner-w3pvt-wrap">
								<div class="inner-sec-grid">
									...
									<p class="mt-3">Experience serenity and tranquility with our less-crowded destinations, perfect for a peaceful and relaxing vacation.</p>
								</div>
							</div>
							<div class="col-lg-4 col-md-6 inner-w3pvt-wrap">
								<div class="inner-sec-grid">
									...
									<p class="mt-3">Expert agents, seamless travel. Let us handle the details for your next adventure.</p>
								</div>
							</div>
							<div class="col-lg-4 inner-w3pvt-wrap">
								<div class="inner-sec-grid">
									...
									<p class="mt-3">Experience hassle-free travel with our easy trip packages. Let us take care of your itinerary.</p>
								</div>
							</div>
						</div>
					</section>
		...
		<div class="row pt-xl-4">
			<div class="col-md-4 test-grid px-lg-4">
				<div class="testi-info text-center">
					<p class="text-li">"Efficient booking process, excellent customer service & great prices. Highly recommend for travel planning."</p>
					<div class="test-img text-center mt-4">
						<img src="images/te1.jpg" class="img-fluid" alt="user-image">
					</div>
					<h3 class="mt-md-4 mt-3">Elisa</h3>
				</div>
			</div>
			<div class="col-md-4 test-grid px-lg-4 my-md-0 my-5">
				<div class="testi-info text-center">
					<p class="text-li">"Great site! Easy to navigate, find affordable packages, and book travel. I recommend this site for trip planning."</p>
					<div class="test-img text-center mt-4">
			...
			<div class="col-md-4 test-grid px-lg-4">
				<div class="testi-info text-center">
					<p class="text-li">"Easy to navigate, great prices & fantastic customer service. I highly recommend for booking your next adventure!"</p>
					<div class="test-img text-center mt-4">
