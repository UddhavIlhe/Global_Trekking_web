	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
      ...
      <nav class="navbar navbar-inverse">
          <div class="navbar-header">
            ...
            <h1><a class="navbar-brand" href="dashboard.php"><span class="fa fa-area-chart"></span> Glance<span class="dashboard_text">Design dashboard</span></a></h1>
          </div>
...
<section id="main-content">
 ...
 <div class="panel panel-default">
    <!-- <div class="panel-heading">Contact View
    </div> -->
    <div>
<br>
    <?php
    include "config.php";
	$add  = mysqli_query($conn,"select * from booknow") or die(mysqli_error($conn));
	?>
      <table class="table">
        <thead>
          <tr>
            ...
            <th data-breakpoints="xs sm md" data-title="DOB">Date</th>
              <th data-breakpoints="xs">Adults</th>
            <th data-breakpoints="xs sm md" data-title="DOB">Kids</th>
            <th data-breakpoints="xs sm md" data-title="DOB">City</th>
            <th data-breakpoints="xs sm md" data-title="DOB">Message</th> -->
            <!-- <th>Action</th> -->
          </tr>
        </thead>
        <tbody>
				...
				<tr>
					...
					<td>
                    <!-- <a href="deletebooking.php?stud_id=<?php echo $id; ?>">
                    <button class ="btn-danger" type="button" name="delete2">Delete</button>
                    </a> -->
                    <!-- <a href="contact_update.php?stud_id=<?php echo $id; ?>">
                    <button class ="btn-success" type="button" name="update">Upadte</button>
                    </a> -->
                    </td>
				</tr>
